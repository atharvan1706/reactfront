  ...
  return (
    ...
    >
      ...
      <g filter={`url(#${filterId})`}>
        <path d="M35.048,0.053 c-17.513,0 -31.703,13.987 -31.703,30.984 l31.795,-0.091 L35.048,0.053z" fill={startColor} />
        <path d="M35.048,2.053 c-16.413,0 -29.703,13.087 -29.703,28.984 l29.795,-0.091 L35.048,2.053z" fill={`url(#${gradientId}_metal)`} />
        <path d="M35.048,4.053 c-15.313,0 -27.703,12.187 -27.703,26.984 l27.795,-0.091 L35.048,4.053z" fill={`url(#${gradientId}_metal)`} />
        <path d="M35.048,6.053 c-14.213,0 -25.703,11.287 -25.703,24.984 l25.795,-0.091 L35.048,6.053z" fill={`url(#${gradientId}_metal)`} />
        <path d="M35.048,8.053 c-13.113,0 -23.703,10.387 -23.703,22.984 l23.795,-0.091 L35.048,8.053z" fill={endColor} />
      ...
      <g filter={`url(#${filterId})`}>
        <path d="M34.616,0 c17.513,0 31.702,13.987 31.702,30.984 l-31.794,-0.09 L34.616,0z" fill={startColor} />
        <path d="M34.616,2 c16.413,0 29.702,13.087 29.702,28.984 l-29.794,-0.09 L34.616,2z" fill={`url(#${gradientId}_metal)`} />
        <path d="M34.616,4 c15.313,0 27.702,12.187 27.702,26.984 l-27.794,-0.09 L34.616,4z" fill={`url(#${gradientId}_metal)`} />
        <path d="M34.616,6 c14.213,0 25.702,11.287 25.702,24.984 l-25.794,-0.09 L34.616,6z" fill={`url(#${gradientId}_metal)`} />
        <path d="M34.616,8 c13.113,0 23.702,10.387 23.702,22.984 l-23.794,-0.09 L34.616,8z" fill={endColor} />
